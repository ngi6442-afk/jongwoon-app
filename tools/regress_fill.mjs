...
await run('선금지급신청', async () => {
  await save('R_선금세트.hwpx', await fillHwpxTemplate(b64of(DATA + '/6. 자료/계약서류분석/선금지급신청_템플릿.hwpx'),
    { '발주기관': '회귀테스트교육지원청', '수신': '회귀테스트교육지원청 (분임)재무관', '참조': '재정지원담당',
      '문서번호': '209901-01', '시행일자': '2099.01.02.', '작성일': '2099.01.02.', '담당자': '나경일 과장',
      '이메일': 'jongwoon1202@daum.net', '전화': '054)291-1204', '팩스': '054)291-1214',
      '계약건명': '회귀테스트 다목적강당 석면해체 및 제거공사', '상호': '주식회사 종운건설', '주소': '경북 포항시 남구 정몽주로 823-10', '대표자': '나 종 운',
      '계약기간': '2099.01.01. ～ 2099.03.01.', '계약일': '2099.01.01.', '착공일': '2099.01.02.', '준공예정일': '2099.03.01.',
      '계약금액한글': '일억', '계약금액': '100,000,000', '선금신청액한글': '삼천만', '선금신청액': '30,000,000',
      '잔액한글': '칠천만', '잔액': '70,000,000', '직접노무비한글': '사천만', '직접노무비': '40,000,000',
      '차액한글': '육천만', '차액': '60,000,000', '적용요율': '50.00',
      '노무비': '20,000,000', '재료비': '3,000,000', '사급자재': '2,272,727', '경비': '2,000,000',
      '소계': '27,272,727', '부가세': '2,727,273',
      '은행명': '대구은행', '예금종류': '하도급지킴이', '계좌번호': '000-000000-00-000' }));
});
